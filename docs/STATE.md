...
v0.7.104. `ROADMAP.md` remains the authoritative, per-release history — this page is the "where are
...
real Xtream provider with a ~30k-channel catalog. Current release: **v0.7.104** (see ROADMAP for the
full history). Test suite: **413 passing**. CI (typecheck/lint/test/build) and the three-platform
